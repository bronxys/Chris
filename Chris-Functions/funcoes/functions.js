...
const ceemde = JSON.parse(fs.readFileSync('./Chris-Dados/data/totalcmd.json'));
...
const banner2 = cfonts.render((`CHRIS BOT OFICIAL\nCREATOR: LUCAS\nVERSION: 3.9.5`), {
font: 'console',
align: 'center',
...
const banner3 = cfonts.render((waktoo), {
  font: 'block',
  align: "center",
...
chyt = `556196697514@s.whatsapp.net`
dono32 = `556196697514@s.whatsapp.net`
